                                ...
                                <div class="row-item">
                                  ...
                                  <% if (i == 0) {  %>
                                    <% if ((j == 1) && rows.length == 1) {  %>
                                      <span class="s-circle-number" data-number="<%=item.value.val%>" data-label="<%=item.value.label%>" data-color="<%=color%>"></span>
                                    <% } else { %>
                                      <span class="s-circle-number" data-number="<%=item.value.val%>" data-label="<%=item.value.label%>"></span>
                                    <% } %>
                                  <% } else { %>
                                    <span class="s-circle-number" data-number="<%=item.value.val%>" data-label="<%=item.value.label%>" data-color="<%=color%>"></span>
                                  <% } %>
